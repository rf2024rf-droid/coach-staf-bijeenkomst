        ...
        <section className="grid gap-4 md:grid-cols-3">
          <article className="rounded-lg border border-zinc-300 bg-white p-4 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-sm font-semibold text-zinc-600">Vragen</span>
              <BarChart3 aria-hidden className="h-5 w-5 text-emerald-800" />
            </div>
            <p className="mt-2 text-3xl font-black">{payload.totals.questions}</p>
          </article>
          <article className="rounded-lg border border-zinc-300 bg-white p-4 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-sm font-semibold text-zinc-600">Antwoorden</span>
              <Send aria-hidden className="h-5 w-5 text-sky-800" />
            </div>
            <p className="mt-2 text-3xl font-black">{payload.totals.answers}</p>
          </article>
          <article className="rounded-lg border border-zinc-300 bg-white p-4 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="text-sm font-semibold text-zinc-600">Deelnemers</span>
              <Users aria-hidden className="h-5 w-5 text-amber-700" />
            </div>
            <p className="mt-2 text-3xl font-black">{payload.totals.participants}</p>
          </article>
        </section>
          ...
          <section className="flex flex-col gap-6">
            <article className="rounded-lg border border-zinc-300 bg-white p-5 shadow-sm">
              <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div>
                  <h2 className="text-lg font-bold">Live bediening</h2>
                  <p className="text-sm text-zinc-600">
                    {payload.presentation.screenView === "qr"
                      ? "Op het grote scherm staat nu de QR-code groot in beeld."
                      : payload.presentation.screenView === "results"
                        ? "Op het grote scherm staan nu de resultaten groot in beeld."
                      : payload.activeQuestion
                        ? payload.activeQuestion.prompt
                        : "Er staat geen vraag open."}
                  </p>
                </div>
                <button
                  className="inline-flex items-center justify-center gap-2 rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm font-bold hover:bg-zinc-50 disabled:opacity-60"
                  disabled={saving || !payload.activeQuestion}
              ...
              {payload.activeQuestion ? <ResultView question={payload.activeQuestion} /> : null}
            </article>

            <article className="rounded-lg border border-zinc-300 bg-white p-5 shadow-sm">
              <div className="mb-4 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <h2 className="text-lg font-bold">Vragen</h2>
                <button
                    ...
                    <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                      ...
                      <div className="flex flex-wrap gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-2 rounded-lg border border-zinc-300 bg-white px-3 py-2 text-sm font-bold hover:bg-zinc-100 disabled:opacity-40"
                        ...
                        <button
                          className={`inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-bold disabled:opacity-60 ${
                            payload.presentation.screenView === "results" &&
                        ...
                        <button
                          className={`inline-flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-bold text-white disabled:opacity-60 ${
                            question.id === payload.presentation.activeQuestionId
            ...
            <section className="grid gap-4">
              {payload.questions.map((question) => (
                <article className="rounded-lg border border-zinc-300 bg-white p-5 shadow-sm" key={question.id}>
